...
class mc6809 : virtual public USim {
...
protected:
    ...
    union {
        ...
        struct {
#ifdef MACH_BITFIELDS_MSB_FIRST
            Byte        e : 1;    // Entire
...
private:
    ...
    void			help_sub(Word&);
    void			help_tst(Byte);
    void 			math_cc_byte(Byte *, int, Byte);
    void 			sub_byte(Byte *, Byte);
...
private:
    // For displaying arguments to opcodes when debugging
    void D_Illegal(char *);
    void D_Direct(char *);
    void D_Page10(char *);
    void D_Page11(char *);
    void D_Immediate(char *);
    void D_ImmediateL(char *);
    void D_Inherent(char *);
    void D_Indexed(char *);
    void D_Extended(char *);
    void D_Relative(char *);
    void D_RelativeL(char *);
    void D_Register0(char *);
    void D_Register1(char *);
    void D_Register2(char *);
};
